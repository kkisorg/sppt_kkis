    ...
    <div class="row">
        <div class="col xs-12 col-sm-6 col-sm-offset-3 col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3">
            <div class="panel panel-default">
                ...
                <form action="/document/update" role="form" method="POST" class="form-vertical" enctype="multipart/form-data" onsubmit="return Validate(this);">
                    {{ csrf_field() }}
                    ...
                    <div class="panel-body">
                        <div class="row form-group center-block">
                            ...
                            <ul id="type-ul">
                                <li class="form-group"><label for="document-type-bulletin" class="radio-inline"><input type="radio" name="document-type" id="document-type-bulletin" value="bulletin" @if ($document->type == 'bulletin') checked @endif> Buletin </label></li>
                            </ul>
                        </div>
                        <div class="row form-group center-block">
                        ...
                        <div class="row form-group center-block">
                            ...
                            <div class='input-group date' id='publishdatetimepicker'>
                                <input type='text' class="form-control" name="publish-datetime" id="publish-datetime" required value="{{ $document->publish_datetime }}">
